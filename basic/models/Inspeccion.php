 ...
 * @property integer $estructur_eq_idestructur_eq
 ...
 * @property EstructurEq $estructurEqIdestructurEq
...
class Inspeccion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nodo_idnodo', 'estructur_eq_idestructur_eq', 'estacion_idestacion'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'estructur_eq_idestructur_eq' => 'Estructur Eq Idestructur Eq',
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getEstructurEqIdestructurEq()
    {
        return $this->hasOne(EstructurEq::className(), ['idestructur_eq' => 'estructur_eq_idestructur_eq']);
    }
