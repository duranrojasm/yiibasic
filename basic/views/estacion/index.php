...
/* @var $searchModel app\models\EstacionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Estacions';
...
'enablePushState' => false]);?>
    <?= GridView::widget([
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Estación', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Estaciones</h3>',
        'type'=>'warning',
