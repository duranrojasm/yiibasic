...
$this->title = 'Partes de Enlace Satelital';
...
<?php Pjax::begin(['id'=>'segurGrid', 'timeout' => false, 
'enablePushState' => false]);?>
 ...
 <?= GridView::widget([
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Parte de Enlace', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Partes de Enlaces Satelitales</h3>',
        'type'=>'warning',
