...
<div class="inspeccion-view">
  ...
  foreach ($a as  $value) {
     //print_r($value);
     print_r( "<center><a href='uploads/".$model->estacionIdestacion->nombre.'-'.$model->idinspeccion.'/'.$value."'><img style=\"width:30%\" src='uploads/".$model->estacionIdestacion->nombre.'-'.$model->idinspeccion.'/'.$value."' class=\"img-responsive\"></a></center>");
