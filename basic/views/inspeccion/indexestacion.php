...
<div class="inspeccion-index">
    ...
    <?php Pjax::begin(['id'=>'localGrid', 'timeout' => false,'enablePushState' => false]);?>
        ...
        'columns' => [
           ...
           //   'value' => function ($data2) {
            ...
            [
                'attribute'=>'atraso',
                'label' => 'Atraso',
                'value'=>'\'<b><span style="color:red">\'.$model->atraso($model->fecha_insp).\'</span></b><br><b><span style="color:red">\'</span></b>\'',
            ...
            [
             ...
             ['class' => 'yii\grid\ActionColumn',
              'contentOptions' => ['style' => 'width: 100px;', 'class' => 'text-center'],
                'template' => '{viewestacion}{update}{delete}{javi_button}',
                'buttons' => ['javi_button' => function ($url, $model) {
                                return Html::a('<span class="glyphicon glyphicon-pushpin"></span>',['estacion']);
                        }],
                ],
        ],
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Inspeccion', ['estacion'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['indexestacion'], ['class' => 'btn btn-link']),
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'type'=>'warning',
            ...
            'after'=>Html::a('<i class="glyphicon glyphicon-repeat"></i> Actualizar', ['indexestacion'], ['class' => 'btn btn-warning btn-sm']),
        'footer'=>true
