...
<div class="enlace-satelital-index">
 ...
 <?php $gridColumns =[
            ...
            [
                'attribute'=> 'torre_idtorre',
                'value'=>'torreIdtorre.codigo',
                'label'=>'Torre',
               
            ],
                [
             'attribute'=>'cliente_idcliente',
              'value'=>'clienteIdcliente.nombre',
              'label'=>'Cliente',
...
'enablePushState' => false]);?>
    <?= GridView::widget([
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Registrar Enlace Satelital', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Enlaces Satelitales</h3>',
        'type'=>'warning',
