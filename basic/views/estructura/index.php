...
'enablePushState' => false]);?>
    <?= GridView::widget([
        ...
        'filterModel' => $searchModel,
         'columns' =>  [
           ...
           /*  [
              ...
              [
                'attribute'=>'tipo_estructura_idtipo_estructura',
                'value'=>'tipoEstructuraIdtipoEstructura.nombre',
                'label'=>'Tipo',
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Estructura', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Estructuras</h3>',
        'type'=>'warning',
