...
'enablePushState' => false]);?>
 ...
 <?= GridView::widget([
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Parte de Radio', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Partes de Radios</h3>',
        'type'=>'warning',
