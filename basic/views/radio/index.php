...
'enablePushState' => false]);?>
    <?= GridView::widget([
        ...
        'filterModel' => $searchModel,
         'columns' =>  [
           ...
           /*  [
            ...
            [
                'attribute'=> 'modelo_idmodelo',
                'value'=>'modeloIdmodelo.nombre',
                'label'=>'Modelo',
             ...
             'attribute'=>'estacion_idestacion',
              'value'=>'estacionIdestacion0.nombre',
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Radio', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Radios</h3>',
        'type'=>'warning',
