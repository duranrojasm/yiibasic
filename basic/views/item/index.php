...
$this->title = 'Items de Inspección';
...
'enablePushState' => false]);?>
 ...
 <?= GridView::widget([
        ...
        [
            'content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Crear Item de Inspección', ['create'], ['class' => 'btn btn-warning'],['id'=>'modalButton']) 
                . ' '.
     ...
     '{toggleData}',
       ...
       // 'export'=>true,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title">Item de Inspección</h3>',
        'type'=>'warning',
